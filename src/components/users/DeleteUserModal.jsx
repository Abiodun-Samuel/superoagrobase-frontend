...
const DeleteUserModal = memo(({ isOpen, onClose, user, onConfirm, isDeleting }) => {
    const { canDelete, isSelf, isSuperAdmin } = useUserPermissions(user);

    if (!user) return null;

    const handleConfirm = () => onConfirm(user.id);
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-red-700 dark:text-red-300">
                                Deleting this user will permanently remove all their data, including profile
                                information, orders, and activity history. This action cannot be reversed.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Type{' '}
                            <span className="font-mono font-semibold bg-gray-100 dark:bg-gray-800 px-1 rounded">
                                DELETE
                            </span>{' '}
                            to confirm:
                        </p>
