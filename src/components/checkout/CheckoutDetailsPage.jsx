...
import { useCompleteOrder } from '@/queries/orders.query';
...
const CheckoutDetailsPage = () => {
    ...
    const getHeaderInfo = () => {
        ...
        if (!hasItems) return null; // No header for empty state
        return {
            title: "Secure Checkout",
            description: `Complete your order of ${itemCount} ${itemCount === 1 ? 'item' : 'items'}. All transactions are secure and encrypted.`,
            itemCount
        };
    };
        ...
        return (
            <div className="min-h-screen mx-auto my-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Main Form */}
                    <form onSubmit={handleSubmit(onCreateOrder)} className="lg:col-span-2 space-y-6">
    ...
    return (
        <div className='space-y-10 my-10'>
            {headerInfo && (
                <div className="border-b border-gray-200 bg-gradient-to-r from-green-50 via-white to-green-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                        <div className="flex items-center justify-between">
                            ...
                            {headerInfo.itemCount && (
                                <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-white border border-green-200 rounded-lg shadow-sm">
                                    <Package2Icon className="w-5 h-5 text-green-600" />
