...
const NavItem = ({ item, isActive, onToggle, pathname }) => {
    ...
    const buttonClasses = `flex items-center space-x-1 px-4 py-2 rounded-xl transition-all duration-200 font-medium group whitespace-nowrap ${isCurrentPath ? 'text-green-600 bg-gray-100' : 'text-gray-700 hover:text-green-600 hover:bg-gray-100'}`;
